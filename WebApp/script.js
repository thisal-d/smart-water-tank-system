const SERVER_URL = 'http://192.168.102.185:5000';
...
const waterQalitylValueEl = document.getElementById("water-quality-value-mgl");     
...
async function fetchStatus() {
    try {
        ...
        waterQalitylValueEl.textContent = data["water_mgl_value"] + " Mgl";
